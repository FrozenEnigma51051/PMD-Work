...
<body>
    <div class="container py-4">
        ...
        <form id="weatherObservationForm" method="POST" action="{{ route('public.weather.observation.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="personal_phone" class="form-label">Phone Number</label>
                            <input type="tel" class="form-control" id="personal_phone" name="personal_phone" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="personal_email" class="form-label">Email Address</label>
